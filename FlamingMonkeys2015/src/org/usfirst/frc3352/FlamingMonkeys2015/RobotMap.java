...
public class RobotMap {
    ...
    public static Victor intakeLeftIntake;
    public static Victor intakeRightIntake;
    ...
    public static void init() {
        ...
        drivetrainLeftEncoder.setDistancePerPulse(.00909);//distance is in inches
        drivetrainLeftEncoder.setSamplesToAverage(127);
        drivetrainLeftEncoder.setMinRate(.01);
        ...
        drivetrainRightEncoder.setDistancePerPulse(.00909);//distance is in inches
        drivetrainRightEncoder.setSamplesToAverage(127);
        drivetrainRightEncoder.setMinRate(.01);
        ...
        intakeLeftIntake = new Victor(3);
        LiveWindow.addActuator("Intake", "LeftIntake", intakeLeftIntake);
        
        intakeRightIntake = new Victor(4);
        LiveWindow.addActuator("Intake", "RightIntake", intakeRightIntake);
